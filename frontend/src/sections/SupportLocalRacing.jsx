...
export default function SupportLocalRacing() {
  return (
    <section id="racing" className="py-16 px-4 md:px-6">
      <div
        className="relative max-w-[1440px] mx-auto border-2 border-brand-red rounded-lg overflow-hidden bg-cover bg-center py-16 px-6 md:px-10"
